...
CREATE (:KG:Bauteil {id: 'bauteil:000000075612247', owner: 'huber-ag', kgType: 'Bauteil', tier: 1, sichtbar: 15, verborgen: 11, stufe: 1, materialnummer: '000000075612247', materialkurztext: 'SchneeschutzgitterØ220mmf.Tyfon,CJ', benennung: 'Schneeschutzgitter Ø 220 für Tyfon', kurztext: 'Schneeschutzgitter', werkstoff: 'X5CrNi18-10 - 1.4301', normBezeichnung: 'EN 10088-3', abmessung: '95XØ202MM', laenge: 0, breite: 0, hoehe: 0, volumen: 0, nettogewicht: 0.25, bruttogewicht: 0.25, gewichtseinheit: 'KG', edcAssetId: 'stammdaten-000000075612247', withheld: ['Bestandsmenge', 'Bestandswert', 'Dokumentnummer', 'Ersteller', 'Ersteller-SachNr', 'Identnummer', 'Lieferant', 'Planlieferzeit (Ø)', 'Preis', 'Sicherheitsbestand (Ø)', 'Zeichnungsnummer (Hersteller)']});
