...
CREATE (:KG:Drucker {id: 'drucker:P1', owner: 'consumer', kgType: 'Drucker', tier: 1, sichtbar: 3, verborgen: 1, stufe: 2, printId: 'P1', herstellerName: 'Stratasys', modell: 'Stratasys_F170', withheld: ['Seriennummer']});
CREATE (:KG:Bauteil {id: 'bauteil:000000075612247', owner: 'consumer', kgType: 'Bauteil', tier: 1, sichtbar: 21, verborgen: 4, stufe: 2, materialnummer: '000000075612247', materialkurztext: 'SchneeschutzgitterØ220mmf.Tyfon,CJ', benennung: 'Schneeschutzgitter Ø 220 für Tyfon', kurztext: 'Schneeschutzgitter', werkstoff: 'X5CrNi18-10 - 1.4301', normBezeichnung: 'EN 10088-3', abmessung: '95XØ202MM', laenge: 0, breite: 0, hoehe: 0, volumen: 0, nettogewicht: 0.25, bruttogewicht: 0.25, gewichtseinheit: 'KG', bestandsmenge: 5, bestandswert: 5, sicherheitsbestand: 2.2, planlieferzeit: 90, preis: 163.766, lieferant: 'KNORR-BREMSE', ersteller: 'Knorr-Bremse [129]', withheld: ['Dokumentnummer', 'Ersteller-SachNr', 'Identnummer', 'Zeichnungsnummer (Hersteller)']});
...
CREATE (:KG:Fertigungsdaten {id: 'charge:P1', owner: 'consumer', kgType: 'Fertigungsdaten', tier: 1, sichtbar: 5, verborgen: 1, stufe: 2, chargeId: 'CHG-P1', printId: 'P1', messwerte: 1514, zeitraumVon: '2026-07-02T00:00:00', zeitraumBis: '2026-07-02T00:00:00', withheld: ['Rohdaten-Referenz']});
...
CREATE (:KG:Drucker {id: 'drucker:P1', owner: 'provider', kgType: 'Drucker', tier: 1, sichtbar: 3, verborgen: 1, stufe: 2, printId: 'P1', herstellerName: 'Stratasys', modell: 'Stratasys_F170', withheld: ['Seriennummer']});
...
CREATE (:KG:Fertigungsdaten {id: 'charge:P1', owner: 'provider', kgType: 'Fertigungsdaten', tier: 1, sichtbar: 5, verborgen: 1, stufe: 2, chargeId: 'CHG-P1', printId: 'P1', messwerte: 1514, zeitraumVon: '2026-07-02T00:00:00', zeitraumBis: '2026-07-02T00:00:00', withheld: ['Rohdaten-Referenz']});
...
CREATE (:KG:Drucker {id: 'drucker:P1', owner: 'rheinmetall', kgType: 'Drucker', tier: 1, sichtbar: 3, verborgen: 1, stufe: 2, printId: 'P1', herstellerName: 'Stratasys', modell: 'Stratasys_F170', withheld: ['Seriennummer']});
...
CREATE (:KG:Fertigungsdaten {id: 'charge:P1', owner: 'rheinmetall', kgType: 'Fertigungsdaten', tier: 1, sichtbar: 5, verborgen: 1, stufe: 2, chargeId: 'CHG-P1', printId: 'P1', messwerte: 1514, zeitraumVon: '2026-07-02T00:00:00', zeitraumBis: '2026-07-02T00:00:00', withheld: ['Rohdaten-Referenz']});
